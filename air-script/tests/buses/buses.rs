...
impl Air for BusesAir {
          ...
          E: FieldElement<BaseField = Felt> + ExtensionOf<F>,
    {
        ...
        result[0] = (E::ONE + (aux_rand_elements.get_segment_elements(0)[0] + E::ONE * aux_rand_elements.get_segment_elements(0)[1]) * E::ONE + E::ONE - E::ONE) * aux_current[0] - (E::ONE + (aux_rand_elements.get_segment_elements(0)[0] + E::ONE * aux_rand_elements.get_segment_elements(0)[1]) * E::ONE + E::ONE - E::ONE) * aux_next[0];
